...
//==================================================== data files
   ...
   chainAlpha->Add("data/gen_run25.root"); //28Mg
   
   //chain->Add("../../root_data/gen_run92.root");
   //chain->Add("../../root_data/gen_run5[6-9].root");
   //chain->Add("../../root_data/gen_run6[0-9].root");
   //chain->Add("../../root_data/gen_run7[0-9].root");
   //chain->Add("../../root_data/gen_run8[0-9].root");
   // chain->Add("../../root_data/gen_run9[0-9].root");
   //chain->Add("../../root_data/gen_run10[4-7].root");

/**///=========================================== Calibration
   if( option > 5 || option < 0 ) {
     printf("========= invalid action. Bye bye~ \n");
     gROOT->ProcessLine(".q");
     return;
   }
   ...
   if( option == 4 ) {
      ...
      if(fs->IsOpen()){
         ...
         if( eCdet == -1) {
	   printf("=====================================\n");
           printf("========== Generate a new root file for new calibration parameters =======\n");
	    printf(" ================ files :  \n");
            chain->GetListOfFiles()->Print();
            printf(" ================================================== \n");
