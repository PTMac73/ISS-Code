...
// GLOBAL VARIABLES
TChain *ch1, *ch2, *chAlpha0, *chAlpha1;
TFile *f0, *f1, *f2, *fAlpha0, *fAlpha1;
...
void SharpChain(){
	...
	chainRuns( runArrayAlpha0, chAlpha0, fAlpha0, "../root_data/genAlpha0.root" );
	chainRuns( runArrayAlpha1, chAlpha1, fAlpha1, "../root_data/genAlpha1.root" );
}
